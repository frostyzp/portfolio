  ...
  return (
    <div className="content">
      ...
      <section className="section hero-section">
        <img src="/assets/byos/byos main copy.png" alt="Illustration Guidelines hero" className="rounded-img" />
      </section>
      ...
      <section className="section context-section">
        ...
        <img src="/assets/byos/frame-1 copy.png" alt="Illustration system usage" className="rounded-img" />     
