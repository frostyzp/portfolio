  ...
  return (
    <div className="content">
      ...
      <section className="section audit-section">
        ...
        <img src="/byos/byos_prev.png" alt="Design solution overview" className="rounded-img" />     


        {/* <p className="section-lead"> How might illustrations create a more trusted, delightful relationship between Government products in Singapore and members of the public?</p> */}
      </section>
      ...
      <section className="section">
        ...
        <img src="/byos/byos00.png" alt="Illustration guidelines" className="rounded-img" />     
      ...
      <section className="section">
        ...
        <img src="/byos/byos01.png" alt="Illustration guidelines" className="rounded-img" />    
        <img src="/byos/byos02.png" alt="Illustration guidelines" className="rounded-img" />     
        ...
        <img src="/byos/byos04.png" alt="Illustration guidelines" className="rounded-img" />    
        <img src="/byos/byos05.png" alt="Illustration guidelines" className="rounded-img" />  
